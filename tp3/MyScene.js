...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.myPrism = new MyPrism(this, 5, 20);
        this.myCylinder = new MyCylinder(this, 8, 20);
        
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.myUnitCube, this.myPrism, this.myCylinder];
    ...
    initMaterials() {
        ...
        // Wood Material (no diffuse)
        this.woodMaterial = new CGFappearance(this);
        this.woodMaterial.setAmbient(0.5, 0.3, 0.1, 1.0);
        this.woodMaterial.setDiffuse(0.0, 0.0, 0.0, 1.0);
        this.woodMaterial.setSpecular(0.25, 0.15, 0.05, 1.0);
